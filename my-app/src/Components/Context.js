                  ...
                  <div className="info">
                    <header>
                      ...
                      <h5>Top 3 Coins</h5>
                          ...
                          <CTooltip 
                            content={ReactHtmlParser(category?.[0].top_3_coins[1].slice(52, 58))}
                            placement="top"
                          >
                            <img src={category?.[0].top_3_coins[1]} alt={category?.[1].name}></img>
                          </CTooltip>
                          <CTooltip 
                            content={ReactHtmlParser(category?.[0].top_3_coins[2].slice(53, 61))}
                            placement="top"
                          >
