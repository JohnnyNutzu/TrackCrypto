...
//Display description and categories for each coin
const CoinPage = () => {
  const { id } = useParams();
  ...
  return (
    ...
    <div className={classes.container}>
      ...
      <a href={coin?.links.homepage[0]} alt="home"><img src={coin?.image.large} alt={coin?.name}  height="100"  style={{ marginBottom: 20 }}/></a>
        ...
        <div className={classes.marketData}>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
              {ReactHtmlParser(coin?.description.en.split('50')[0])}
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Typography>
